...
Use `@~/.claude/ship-agent/agents/pm-strategist.md` to analyze the scope and pick the *next highest-priority* chunk of work. Group 1-3 related scope items into a single cohesive Feature.

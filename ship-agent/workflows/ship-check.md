...
**Load persona:** `@~/.claude/ship-agent/agents/pm-auditor.md`
**Load checklist:** `@~/.claude/ship-agent/references/launch-checklist.md`
...
Write `.pm/audits/SHIP-CHECK-[YYYY-MM-DD].md` using `@~/.claude/ship-agent/templates/ship-check.md`.

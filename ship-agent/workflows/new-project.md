...
**Load the PM Strategist persona** from `@~/.claude/ship-agent/agents/pm-strategist.md`.
**Load questioning techniques** from `@~/.claude/ship-agent/references/questioning.md`.
...
Synthesize all gathered context into `.pm/PROJECT.md` using the template from `@~/.claude/ship-agent/templates/project.md`.
...
**Load the PM Scoper persona** from `@~/.claude/ship-agent/agents/pm-scoper.md`.
**Load scope patterns** from `@~/.claude/ship-agent/references/scope-patterns.md`.

Analyze PROJECT.md and generate `.pm/SCOPE.md` using the template from `@~/.claude/ship-agent/templates/scope.md`.

...
Create or update `.pm/FEATURES.md` using `@~/.claude/ship-agent/templates/features.md`.
...
Execute `@~/.claude/ship-agent/workflows/map.md` to generate `.pm/ARCHITECTURE.md`.

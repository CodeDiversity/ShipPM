...
<execution_context>
@~/.claude/ship-agent/workflows/roadmap.md
@~/.claude/ship-agent/agents/pm-strategist.md
@~/.claude/ship-agent/references/pm-philosophy.md
@~/.claude/ship-agent/references/prioritization.md
@~/.claude/ship-agent/templates/roadmap.md
</execution_context>
...
<process>
Execute the roadmap workflow from @~/.claude/ship-agent/workflows/roadmap.md end-to-end.
</process>

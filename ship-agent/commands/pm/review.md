...
<execution_context>
@~/.claude/ship-agent/workflows/review.md
@~/.claude/ship-agent/agents/pm-reviewer.md
</execution_context>
...
<process>
Execute the review workflow from @~/.claude/ship-agent/workflows/review.md end-to-end.
</process>

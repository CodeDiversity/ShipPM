...
<execution_context>
@~/.claude/ship-agent/workflows/brief.md
@~/.claude/ship-agent/agents/pm-brief-writer.md
</execution_context>
...
<process>
Execute the brief workflow from @~/.claude/ship-agent/workflows/brief.md end-to-end.
</process>

...
**Load persona:** `@~/.claude/ship-pm/agents/pm-scoper.md`
**Load patterns:** `@~/.claude/ship-pm/references/scope-patterns.md`
...
Write to `.pm/SCOPE.md` using `@~/.claude/ship-pm/templates/scope.md`.

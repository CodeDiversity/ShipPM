...
<execution_context>
@~/.claude/ship-pm/workflows/scope.md
@~/.claude/ship-pm/agents/pm-scoper.md
@~/.claude/ship-pm/references/scope-patterns.md
...
<process>
Execute the scope workflow from @~/.claude/ship-pm/workflows/scope.md end-to-end.
</process>

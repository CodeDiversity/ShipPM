...
Read `.pm/SCOPE.md` and any feature specs in `.pm/features/` that correspond to this Feature's goals. Note what was explicitly requested vs what was explicitly marked out-of-scope.
